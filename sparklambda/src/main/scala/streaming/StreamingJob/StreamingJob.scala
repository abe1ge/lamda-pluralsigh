  ...
  def main(args: Array[String]): Unit = {
    ...
    def streamingApp(sc: SparkContext, batchDuration: Duration) = {
      ...
      val inputPath = isIDE match {
        case true => "file:///C:/Users/work/Documents/plursight/applyingLambdaArchitecture/Boxes/spark-kafka-cassandra-applying-lambda-architecture/vagrant/input"
      ...
      activityStream.transform( rdd => {
        ...
        val activityByProduct = sqlContext.sql("""SELECT product, timestamp_hour,
